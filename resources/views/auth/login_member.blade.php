    ...
    <div class="flex shadow w-full flex-col-reverse lg:flex-row">
        <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
            ...
            <form action="/login_member" method="POST" class="mt-10">
                ...
                <div class="my-3"  id="passwordSection">
                ...
                <div class="flex justify-between">
                    ...
                    <div class="right">
                        <a class="text-blue-400 hover:text-blue-600" href="/forgot_password">Forgot password?</a>
                    </div>
                </div>
                <div class="my-5">
        ...
        <div class="w-full lg:w-1/2 bg-blue-400 flex justify-center items-center">
            <img src="/assets/vayya.jpeg" alt="Login Image" class="w-full">
        </div>
    </div>
</div>
...
<script>
    // cara untuk mendapatkan elemen HTML dengan id "email".
