...
<section class="hero-wrap text-center relative">
        ...
        <div class="container">
          ...
          @foreach ($sliders as $slider)
            <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
              <a href="/front/#">
                <img src="/uploads/{{ $slider->gambar}}" alt="">
                <div class="overlay"></div>
                <div class="promo-inner valign">
                  <h2>{{ $slider->nama_slider}}</h2>
                  <span>{{ $slider->deskripsi}}</span>
                </div>
              </a>                        
            </div>
          @endforeach
      ...
      <section class="section-wrap promo-banners pb-30">
    <div class="container">
        <div class="row align-items-center"> <!-- Menambahkan class align-items-center untuk mengatur perataan vertikal -->
            <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
                <a>
                    <img src="/logo/w2.jfif" alt="" style="max-width: 100%;">
                    <div class=""></div>
                    <div class="promo-inner valign">
                        <!-- <h2>{{ $slider->nama_slider}}</h2>
                        <span>{{ $slider->deskripsi}}</span> -->
            ...
            <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
                <a>
                    <img src="/uploads/rc2.png" alt="" style="max-width: 100%;">
                    <div class=""></div>
                    <div class="promo-inner valign">
                        <!-- <h2>{{ $slider->nama_slider}}</h2>
                        <span>{{ $slider->deskripsi}}</span> -->
            ...
            <div class="col-xs-4 col-xxs-12 mb-30 promo-banner">
                <a>
                    <img src="/logo/b1.png" alt="" style="max-width: 100%;">
                    <div class=""></div>
                    <div class="promo-inner valign">
                        <!-- <h2>{{ $slider->nama_slider}}</h2>
                        <span>{{ $slider->deskripsi}}</span> -->
    ...
    <div class="container">
        <div class="row heading-row">
            <div class="col-md-12 text-center">
                ...
                <h2 class="heading bottom-line">trendy products</h2>
            </div>
        </div>

        <div class="row items-grid justify-content-between">
